...
- **The "Act" gap.** The Take Action step now has a Porto Alegre-specific source layer, but the pattern is still hand-curated. The real value is scaling this to actual community groups, open public-comment windows, and council agendas for every supported city. Where can that data be sourced reliably per-city rather than maintained manually?
